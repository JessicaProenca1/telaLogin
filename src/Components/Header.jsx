...
import { loginCreatorSenha, loginCreatorEmail } from '../redux/actions/actionLogin';
  ...
  render() {
    ...
    return (
      <div>
        ...
        type="submit" 
        id="btn" 
        disabled={(senha === true && email === true) ? null : 'disabled'}
...
const mapStateToProps = (state) => ({
  email: state.telaLogin.email,
  senha: state.telaLogin.senha,
});
